...
public class RoomResource {
  ...
  public static record UpdateRoomRequest(String name, String description) {}
  ...
  public Response createRoom(
      CreateRoomRequest request, @CookieParam(GUEST_TOKEN_COOKIE) String guestToken) {
  ...
  public Response deleteRoom(
      @PathParam("id") Long id, @CookieParam(GUEST_TOKEN_COOKIE) String guestToken) {
    if (guestToken == null || guestToken.isEmpty()) {
      return Response.status(Response.Status.UNAUTHORIZED)
          .entity("{\"error\": \"Authentication required\"}")
          .build();
