...
public interface UserProfileMapper {
  ...
  @Insert(
      "INSERT INTO user_profiles (user_id, profile_data, created_at, updated_at, revision_meta) "
          + "VALUES (#{userId}, #{profileData}::jsonb, #{createdAt}, #{updatedAt},"
          + " #{revisionMeta}::jsonb)")
  ...
  @Update(
      "UPDATE user_profiles SET updated_at = #{updatedAt}, revision_meta = #{revisionMeta}::jsonb"
          + " WHERE id = #{id}")
