 ...
 *
 * <p>DISABLED: This test expects a WireMock server to be available but doesn't declare
 * @QuarkusTestResource. In native mode, the WireMock server is not started, causing connection
 * failures.
 *
