...
public class ExternalServerAuthorizationTest {
  ...
  public void setup() {
    ...
    assertNotNull(authHeader1, "Authorization header should be present for user1");
    ...
    assertNotNull(authHeader2, "Authorization header should be present for user2");
    ...
    assertNotNull(user1RoomId, "Room ID should not be null");
  }
  ...
  public void testMultiUserRoomIsolation() {
    ...
    // Clean up
    try {
      given().header("Authorization", "Bearer " + user1Token).delete("/api/rooms/" + room1Id);
      given().header("Authorization", "Bearer " + user2Token).delete("/api/rooms/" + room2Id);
    } catch (Exception e) {
