...
/**
 * Integration tests for data integrity and special cases.
 * Tests handling of special characters, null values, and edge cases.
 */
@QuarkusTest
public class DataIntegrityIntegrationTest {
    ...
    public void testCreateRoomWithSpecialCharacters() {
        given()
                ...
                .contentType(ContentType.JSON)
                .body("{\"name\":\"Room @#$% with & special chars\",\"description\":\"Testing special chars\"}")
                .when()
                .post("/api/rooms")
                .then()
